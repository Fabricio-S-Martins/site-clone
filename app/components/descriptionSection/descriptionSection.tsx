...
export const DescriptionSection = () => {
    ...
    const teste = document.querySelector('#displaced-div'); 

    if(teste)
    teste.addEventListener('scroll', () => {
      const scrollY = teste.scrollTop; 
      console.log('Valor de scrollY na div:', scrollY);
    });
    ...
    return (
        <div className="flex gap-10 w-full mb-44 pt-48">
            <div className="hidden relative lg:flex lg:w-1/2 ">
                <div id='displaced-div' className={`fixed top-1/3 lg:w-1/2 lg:flex lg:flex-col lg:gap-10 lg:px-20`}>
                    ...
                    <div className='flex justify-center w-full'>
                        <div className='w-52 text-sm pt-6 text-black'>
